 ...
 *   - 'nav' → 'Navigation'
 */
export function tagToComponentName(tag, classes) {
 ...
 */
export function hasDistinctPattern($, el) {
    const id = $(el).attr('id');
